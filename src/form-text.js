        ...
        <div className="mt-4 mx-auto p-3 rounded" style={{width:'400px',background:'#cee'}}>
             <form>
                <div className="form-group mb-2">
                    ...
                    <input type="text" id="login" name="login" className="form-control form-control-sm" maxLength="20"/>
                </div>
                <div className="form-group mb-2">
                    <label htmlFor="pswd">รหัสผ่าน</label>
                    <input type="password" id="pswd" name="pswd" className="form-control form-control-sm" maxLength="10" ref={textPswd} onBlur={onBlurPassword}/>
                </div>
                <div className="form-group mb-2">
                    <label htmlFor="pswd2">ใส่รหัสผ่านซ้ำ</label>
                    <input type="password" id="pswd2" className="form-control form-control-sm" maxLength="10" ref={textPswd2} onBlur={onBlurPassword2}/>
                </div>                       
