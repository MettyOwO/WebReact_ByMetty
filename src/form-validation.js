...
export default function FormValidation() {
    ...
    const onSubmitForm = (event) => {
        ...
        if(inputFile.current.files.length > maxNumFiles){
            alert(`เลือกได้ไม่เกิน ${maxSize} ไฟล์`)
        ...
        <div className="mt-3 mb-5 mx-auto p-3 rounded" style={{ width:'400px', background:'#cee'}}>
            <form onSubmit={handleSubmit(onSubmitForm)}>
                ...
                <div className="form-group mb-3">
                    ...
                    <input type="text" id="name" name="name" maxLength="50" className="form-control form-control-sm"{...register('name',{required: true, maxLength: 30})}/>
                ...
                <div className="form-group mb-3">
                    <label htmlFor="detial">รายละเอียดสินค้า *</label>
                ...
                <div className="form-group mb-3">
                    ...
                    <input type="file" id="file" name="file" accept="image/*" className="form-control form-control-sm" ref={inputFile} multiple/>
                </div>
